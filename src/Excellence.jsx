  ...
  return (
    <div>
      <div className="flex flex-col items-center justify-center mt-[5%] text-[clamp(23px,3.5vw,35px)] font-light">
        ...
        <span>ourselvesourselves in the relationships we</span>
        <span>build with our customers. Whether you are</span>
        <span>looking for a small backyard project or a</span>
        <span>large commercial renovation, we will work with</span>
        <span>you to make sure your plans go to action asap.</span>
        <span>With a close-knit local team you can expect</span>
        <span>fast - and easy - communication. Our services</span>
        <span>include residential, commercial, and other</span>
        <span>miscellaneous projects. If you have an idea,</span>
        <span>we’ll work with you to help get it done! Working</span>
        <span>with pros has never been easier. Call us today</span>
        <span>for a free consultation — we’re</span>
