...
function Financial() {
  return (
    <div className="min-h-screen flex flex-col">
      {/* Image container */}
      <div className="w-full relative overflow-hidden shadow-lg aspect-video h-[35vw] min-h-[200px] max-h-[425px] flex-shrink-0">
        <img
          src="/bank.webp"
      ...
      <div className="flex flex-col flex-grow justify-center items-center px-[5%] text-center text-black font-light max-w-[900px] mx-auto">
        {/* Large screen content */}
        <div className="hidden smal:flex flex-col text-[clamp(15px,2vw,20px)] gap-1 mt-[5%] px-4 max-w-[900px] mx-auto">
        ...
        <button className="flex flex-row justify-center items-center mt-4 bg-dark-blue cursor-pointer text-white h-[8vw] w-[70%] rounded-md text-[clamp(16px,2vw,28px)] hover:bg-dark-blue/80 mx-auto">
            <span>Learn More About Financing</span>
            <svg
            fill="currentColor"
            viewBox="0 0 512 512"
            className="text-white h-[45%] w-[10%] ml-[3%]"
        ...
        <div className="flex smal:hidden flex-col text-[clamp(15px,1.6vw,18px)] gap-1">
          ...
          <button className="mt-8 bg-dark-blue cursor-pointer text-white h-[13vw] w-[80%] rounded-md text-[clamp(18px,3.5vw,35px)] hover:bg-dark-blue/80 mx-auto">
